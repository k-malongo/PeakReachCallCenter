export default function Header() {
	return (
		<div id="header">
            <img className="background" src="/public/images/backgroundheader.png" alt="peakreach"/>
			<div className="content">

				<div className="card">
					<h2 className="title">
						Empowering Customer Experiences with Innovation and Sustainability
						in Kenya's Premier Call Center
					</h2>
					<h3 className="description">
						PeakReach is a Kenyan call center where customer satisfaction,
